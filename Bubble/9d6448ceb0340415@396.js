...
{
  const groups = {
    "inactive": { x: width/5, y: 3*height/6, color: "#c9c9c9", cnt: 0, fullname: "Yet to arrive" },
    "wait": { x: 2*width/5, y: 3*height/6, color: "#BEE5AA", cnt: 0, fullname: "Waiting" },
    ...
    "finish": { x: 5*width/5, y: 3*height/6, color: "match", cnt: 0, fullname: "Finished" },
  };
  return groups
}
);
